...
help:
	...
	@echo '   make dockerhtml                     (re)generate the web site for docker'
	@echo '   make clean                          remove the generated files          '
	@echo '   make clean-theme                    remove the generated files for theme'
	@echo '   make regenerate                     regenerate files upon modification  '
	@echo '   make publish                        generate using production settings  '
	@echo '   make serve [PORT=8000]              serve site at http://localhost:8000 '
	@echo '   make dockerserve [PORT=8000]        serve site at http://localhost:8000 '
...
dockerhtml: theme
	$(PELICAN) $(INPUTDIR) -o $(DOCKEROUTPUTDIR) -s $(CONFFILE) $(PELICANOPTS)
...
dockerserve:
ifdef PORT
	cd $(DOCKEROUTPUTDIR) && $(PY) -m pelican.server $(PORT)
else
	cd $(DOCKEROUTPUTDIR) && $(PY) -m pelican.server
endif
...
.PHONY: theme html dockerhtml help clean clean-theme regenerate serve dockerserve serve-global devserver publish github ansible-setup
